/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=StatusEnv workers/status/worker-configuration.d.ts` (hash: e0d90e412d68ced5218b0017bfe6d7b2)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_StatusEnv {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	ANALYTICS: AnalyticsEngineDataset;
	NOTIFICATION_QUEUE: Queue;
	DIAGNOSTIC_QUEUE: Queue;
	DIAGNOSTIC_DLQ: Queue;
	...
	TELEMETRY_AUTH_JSON: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_StatusEnv {}
}
interface StatusEnv extends __BaseEnv_StatusEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "STATUS_VERSION" | "DEPLOYMENT_ID" | "GIT_COMMIT" | "ARTIFACT_DIGEST" | "MACHINE_ISSUER" | "MACHINE_AUDIENCE" | "MACHINE_JWKS_URL" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "PROBE_REGIONAL_CONFIG" | "TELEMETRY_BACKEND_CONFIG_JSON" | "NOTIFICATION_QUEUE_NAME" | "CURSOR_SIGNING_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "NOTIFICATION_WEBHOOK_URL" | "NOTIFICATION_AUTHORIZATION" | "TELEMETRY_AUTH_JSON">> {}
}
