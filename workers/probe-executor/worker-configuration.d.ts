/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/probe-executor/wrangler.jsonc --env-interface=ProbeExecutorEnv workers/probe-executor/worker-configuration.d.ts` (hash: 99047feb4d78d0b40f42862003dc45a9)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_ProbeExecutorEnv {
	...
	EXECUTOR_ALLOWED_KINDS: "[\"http\",\"tcp\",\"dns\"]";
	PROBE_ALLOWED_HOSTS: "[]";
	PROBE_ALLOWED_TCP_PORTS: "[]";
	PROBE_BINDING_CONFIG: "{}";
}
declare namespace Cloudflare {
	interface Env extends __BaseEnv_ProbeExecutorEnv {}
}
interface ProbeExecutorEnv extends __BaseEnv_ProbeExecutorEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_ID" | "GIT_COMMIT" | "ARTIFACT_DIGEST" | "ENVIRONMENT" | "STATUS_VERSION" | "EXECUTOR_ID" | "EXECUTOR_LOCATION" | "EXECUTOR_ALLOWED_KINDS" | "PROBE_ALLOWED_HOSTS" | "PROBE_ALLOWED_TCP_PORTS" | "PROBE_BINDING_CONFIG">> {}
}
