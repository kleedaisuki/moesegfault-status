/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/ops-gateway/wrangler.jsonc --config=wrangler.jsonc workers/ops-gateway/worker-configuration.d.ts` (hash: c0c4da94a488ea9d9296afda09144aa0)
// Runtime types generated with workerd@1.20260911.1 2026-09-12
interface __BaseEnv_Env {
	ACCESS_ISSUER: "https://REPLACE-ME.cloudflareaccess.com";
	ACCESS_AUDIENCE: "REPLACE_ME";
	ACCESS_MAX_TOKEN_AGE_SECONDS: "86400";
	ACCESS_ROLE_MAPPING: "{}";
	OPS_ORIGIN: "https://ops.moesegfault.dev";
	DEPLOYMENT_ID: "";
	GIT_COMMIT: "";
	ARTIFACT_DIGEST: "";
	STATUS_VERSION: "";
	ENVIRONMENT: "development";
	STATUS: Service<typeof import("../status/src/index").AdminRpc>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_ISSUER" | "ACCESS_AUDIENCE" | "ACCESS_MAX_TOKEN_AGE_SECONDS" | "ACCESS_ROLE_MAPPING" | "OPS_ORIGIN" | "DEPLOYMENT_ID" | "GIT_COMMIT" | "ARTIFACT_DIGEST" | "STATUS_VERSION" | "ENVIRONMENT">> {}
}
